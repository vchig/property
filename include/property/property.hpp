...
struct property_read : public property_base {
    ...
    boost::any get() const override { return ( object_->*getter_ )(); }
...
template < typename C, typename T >
struct property_rw< void ( C::* )( const T & ) > : public property_read< C, T > {
    ...
    void set( const boost::any &value ) override { ( read_type::object_->*setter_ )( boost::any_cast< T >( value ) ); }
...
template < typename C, typename T >
struct property_rw< void ( C::* )( T ) > : public property_read< C, T > {
